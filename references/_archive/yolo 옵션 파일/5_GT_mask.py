...
output_vis_dir = 'GT_visualization/'
os.makedirs(output_vis_dir, exist_ok=True)

# 4,5 
CATEGORY_COLORS = {
    1: (123, 45, 210),     # mixed steel
    2: (34, 200, 145),     # machine
    3: (210, 120, 60),     # drum
    4: (80, 170, 250),     # panel
    5: (190, 90, 130),     # trash
    6: (60, 220, 100),     # beam
    7: (255, 160, 40),     # pipe
    8: (140, 75, 200),     # heavy iron
    9: (20, 180, 220),     # mesh
    10: (230, 200, 70),    # structure steel
    11: (100, 240, 180),   # rebar
    12: (255, 90, 90),     # small pipe
    13: (70, 130, 180),    # vehicle
    14: (180, 60, 255),    # square pipe
    15: (255, 200, 120),   # Guillotine
    16: (90, 255, 140),    # LPG GAS cylinder
    17: (200, 100, 50),    # handler
    18: (120, 220, 255),   # plastic
    19: (255, 120, 200),   # Fan
}

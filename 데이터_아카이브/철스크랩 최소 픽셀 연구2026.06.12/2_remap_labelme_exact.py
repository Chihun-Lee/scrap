...
def update_image_reference(
    ...
    image_target = (out_json.parents[1] / "images" / split / image_path.name).resolve()
    data["imagePath"] = Path(os.path.relpath(image_target, out_json.parent)).as_posix()
...
def process_dataset(
    ...
    for json_path in json_files:
        ...
        update_image_reference(data, json_path, out_json, split)

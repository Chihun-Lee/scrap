...
# ====== CATEGORIES ======
CATEGORIES = [
    {"color": [123, 45, 210], "isthing": 1, "id": 1,  "name": "mixed steel"},
    {"color": [34, 200, 145], "isthing": 1, "id": 2,  "name": "machine"},
    {"color": [210, 120, 60], "isthing": 1, "id": 3,  "name": "drum"},
    {"color": [80, 170, 250], "isthing": 1, "id": 4,  "name": "panel"},
    {"color": [190, 90, 130], "isthing": 1, "id": 5,  "name": "trash"},
    {"color": [60, 220, 100], "isthing": 1, "id": 6,  "name": "beam"},
    {"color": [255, 160, 40], "isthing": 1, "id": 7,  "name": "pipe"},
    {"color": [140, 75, 200], "isthing": 1, "id": 8,  "name": "heavy iron"},
    {"color": [20, 180, 220], "isthing": 1, "id": 9,  "name": "mesh"},
    {"color": [230, 200, 70], "isthing": 1, "id": 10, "name": "structure steel"},
    {"color": [100, 240, 180], "isthing": 1, "id": 11, "name": "rebar"},
    {"color": [255, 90, 90],  "isthing": 1, "id": 12, "name": "small pipe"},
    {"color": [70, 130, 180], "isthing": 1, "id": 13, "name": "vehicle"},
    {"color": [180, 60, 255], "isthing": 1, "id": 14, "name": "square pipe"},
    {"color": [255, 200, 120],"isthing": 1, "id": 15, "name": "Guillotine"},
    {"color": [90, 255, 140], "isthing": 1, "id": 16, "name": "LPG GAS cylinder"},
    {"color": [200, 100, 50], "isthing": 0, "id": 17, "name": "handler"},
    {"color": [120, 220, 255],"isthing": 1, "id": 18, "name": "plastic"},
    {"color": [255, 120, 200],"isthing": 1, "id": 19, "name": "Fan"},
]

# ====== Config ======
YOLO_WEIGHTS = "runs/segment/train18/weights/best.pt"
